  ...
  container[audiojs] = {
    ...
    settings: {
      ...
      css: '\
        ...
        .audiojs { width: 37px; height: 36px; background: #e4616e; overflow: hidden; font-family: monospace; font-size: 12px; \
          background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, #e4616e), color-stop(0.5, #e4616e), color-stop(0.51, #e4616e), color-stop(1, #e4616e)); \
          background-image: -moz-linear-gradient(center top, ##e4616e 0%, #e4616e 50%, #e4616e 51%, ##e4616e 100%); \
        ...
        .audiojs .play-pause { width: 25px; height: 40px; padding: 4px 6px; margin: 0px; float: left; overflow: hidden; border-right: 1px solid #fff; } \
